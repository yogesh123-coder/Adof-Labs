  ...
  return <section style={backgroundStyle} className="w-full py-16 md:py-24 bg-gray-950">
      <div className="max-w-[1600px] mx-auto px-4 md:px-6 bg-gray-950">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          const CardContent = <div className="group bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
                {/* Project Image */}
                ...
                <div className="p-8">
                  ...
                  <p className="text-white/70 font-poppins text-sm leading-[1.7] mb-6 tracking-wide">
                    {project.description}
                  </p>
